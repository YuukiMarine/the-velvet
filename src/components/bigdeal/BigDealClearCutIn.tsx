...
const SKINS: Record<'p5' | 'p4' | 'p3' | 'neutral', StageSkin> = {
  p5: {
    ...
    stampStyle: { transform: 'rotate(-2.5deg)', fontFamily: '"Noto Sans SC Black", "Velvet Sans SC", sans-serif' },
  ...
  p3: {
    ...
    stampStyle: { fontFamily: '"Noto Sans SC Black", "Velvet Sans SC", sans-serif' },
