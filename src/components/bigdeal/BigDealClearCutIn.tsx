...
const SKINS: Record<'p5' | 'p4' | 'p3' | 'neutral', StageSkin> = {
  p5: {
    ...
    stampStyle: { transform: 'rotate(-2.5deg)', fontFamily: '"Arial Black", "Noto Sans SC Black", "Noto Sans SC", sans-serif' },
    title: 'mt-4 break-words text-xl font-black italic leading-snug text-[#f0e9df]',
    titleFont: '"Arial Black", "Noto Sans SC Black", "Noto Sans SC", sans-serif',
  ...
  p3: {
    ...
    stampStyle: { fontFamily: '"Arial Black", "Noto Sans SC Black", "Noto Sans SC", sans-serif' },
...
export const BigDealClearCutIn = () => {
  ...
  const bigDealClear = useAppStore(s => s.bigDealClear);
  const clearBigDealClear = useAppStore(s => s.clearBigDealClear);
