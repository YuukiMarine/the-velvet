                  ...
                  <div className="mt-8">
                    ...
                    <div className="relative">
                      <div className="relative bg-white px-6 pb-11 pt-9" style={{ clipPath: 'polygon(7% 0, 100% 3%, 93% 100%, 0 97%)', boxShadow: '0 18px 44px rgba(38,96,140,0.16)' }}>
                        ...
                        <div className="text-center text-[44px] font-black leading-none" style={{ color: P3R.ink, fontFamily: '"Arial Black", "Noto Sans SC Black", "Noto Sans SC", sans-serif' }}>吾即是汝，</div>
                      </div>
                      <div className="relative z-10 -mt-7 px-6 py-4" style={{ background: P3R.blue, clipPath: 'polygon(22px 0, 100% 0, calc(100% - 22px) 100%, 0 100%)', boxShadow: '0 14px 32px rgba(27,87,255,0.35)' }}>
                        <span className="whitespace-nowrap text-[38px] font-black leading-none text-white" style={{ fontFamily: '"Arial Black", "Noto Sans SC Black", "Noto Sans SC", sans-serif' }}>
