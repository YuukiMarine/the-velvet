...
export const ListCard = ({
  ...
  const cardClass = [
    // p5-card / p4-card：给频道各留一个稳定钩子（其他频道无样式）——
    // P5 整卡换不规则剪报形；P4 把纯白卡底翻成奶油浅黄（黄舞台上纯白发冷，用户反馈）
    'p5-card p4-card relative overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-800',
